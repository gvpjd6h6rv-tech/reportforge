...
const RuntimeGeometryApiTemplate = {
  ...
  getSectionRect(secOrId) {
    ...
    const cR = this.canvasRect();
    return runtimeGeometryRect(this, (sR.left - cR.left) / zoom, (sR.top - cR.top) / zoom, sR.width / zoom, sR.height / zoom);
  },
  ...
  rectToView(r) {
    const z = this.zoom();
    return runtimeGeometryRect(this, r.x * z, r.y * z, r.w * z, r.h * z);
  },
