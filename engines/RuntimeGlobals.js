...
if (typeof RuntimeHelpers === 'undefined' || !RuntimeHelpers || typeof RuntimeHelpers.install !== 'function') {
  throw new Error('RuntimeHelpers must be loaded before RuntimeGlobals');
}
RuntimeHelpers.install();
