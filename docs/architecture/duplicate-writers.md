...
|---|---|---|---|---|---|---|
| Canvas element DOM | Monolithic `CanvasEngine.renderAll/buildElementDiv` | `CanvasLayoutEngine.renderAll/buildElementDiv` | [designer/crystal-reports-designer-v4.html](/home/mimi/Escritorio/RF/designer/crystal-reports-designer-v4.html#L3256) / [engines/CanvasLayoutEngine.js](/home/mimi/Escritorio/RF/engines/CanvasLayoutEngine.js#L88) | dos implementaciones para `.cr-element` | crítica | `CanvasLayoutEngine` |
...
| DOM contract aliasing | `.cr-element` | alias `.rf-el` injected by monolith | [designer/crystal-reports-designer-v4.html](/home/mimi/Escritorio/RF/designer/crystal-reports-designer-v4.html#L6488) | DOM tests depend on both names | alta | one element contract |
